...
public class Testing2015day0016
{
    ...
    {
        Solution2015day0016.SolvePart1(MainInput).Should().Be(373);
    }

    [TestCase]
    public void TestSolutionPart2()
    {
        Solution2015day0016.SolvePart2(MainInput).Should().Be(260);
    }

    private const string MainInput = @"Sue 1: cars: 9, akitas: 3, goldfish: 0
