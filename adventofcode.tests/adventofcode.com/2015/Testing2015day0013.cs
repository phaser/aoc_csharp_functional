...
public class Testing2015day0013
{
    [TestCase(TestInput, 330)]
    [TestCase(MainInput, 664)]
    public void TestSolutionPart1(string input, int expectedResult)
    {
        Solution2015day0013.SolvePart1(input).Should().Be(expectedResult);
    }

    [TestCase(MainInput, 640)]
    public void TestSolutionPart2(string input, int expectedResult)
    {
        Solution2015day0013.SolvePart2(input).Should().Be(expectedResult);
    }

    private const string TestInput = @"Alice would gain 54 happiness units by sitting next to Bob.
...
David would gain 41 happiness units by sitting next to Carol.";
    ...
    private const string MainInput = @"Alice would lose 2 happiness units by sitting next to Bob.
