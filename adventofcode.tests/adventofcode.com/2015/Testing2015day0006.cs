...
public class Testing2015day0006
{
    [TestCase(MainInput, 569999)]
    public void TestSolutionPart1(string input, int answer)
    {
        Solution2015day0006.SolvePart1(input).Should().Be(answer);
    }

    [TestCase(MainInput, 17836115)]
    public void TestSolutionPart2(string input, int answer)
    {
        Solution2015day0006.SolvePart2(input).Should().Be(answer);
    }

    private const string MainInput = @"turn on 489,959 through 759,964
