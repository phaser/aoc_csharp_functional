...
public class Testing2023day0002
{
    ...
    [TestCase(MainInput, 2169)]
    public void TestSolutionPart1(string input, long answer)
    {
        Solution2023day0002.SolvePart1(input).Should().Be(answer);
    }

    [TestCase(TestInput, 2286)]
    [TestCase(MainInput, 60948)]
    public void TestSolutionPart2(string input, long answer)
    {
        Solution2023day0002.SolvePart2(input).Should().Be(answer);
    }
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green";
    ...
    private const string MainInput = @"Game 1: 2 red, 2 green; 6 red, 3 green; 2 red, 1 green, 2 blue; 1 red
